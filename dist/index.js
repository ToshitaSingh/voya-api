...
})({"2HO6q":[function(require,module,exports,__globalThis) {
...
// });
/* eslint-disable */ // console.log('login.js loaded');
// console.log('axios in login.js:', typeof axios);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts.js":"6Mcnf"}],"jo6P5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const displayMap = (locations)=>{
    ...
    locations.forEach((loc)=>{
        ...
        if (loc.day && loc.description) marker.bindPopup(`Day ${loc.day}: ${loc.description}`);
        bounds.extend([
            lat,
            lng
        ]);
